...
function openLoc(loc) {
  ...
  // Inline SVG brand logos — no network dependency, perfect at any size
  var _svgGoogle =
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width:100%;height:100%;padding:18px;display:block;box-sizing:border-box">' +
    ...
    '</svg>';
  var _svgPint =
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width:100%;height:100%;padding:10px;display:block;box-sizing:border-box">' +
  ...
  _issDiv.innerHTML =
    ...
    '<div class="iss-links">' +
      '<a class="iss-btn" href="https://www.google.com/search?q=' + _issNameEnc + '&tbm=isch" target="_blank" rel="noopener noreferrer">' +
        '<div class="iss-icon">' + _svgGoogle + '</div>' +
      ...
      '<a class="iss-btn" href="https://www.pinterest.com/search/pins/?q=' + _issNameEnc + '" target="_blank" rel="noopener noreferrer">' +
        '<div class="iss-icon">' + _svgPint + '</div>' +
